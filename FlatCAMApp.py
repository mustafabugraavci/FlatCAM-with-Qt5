...
from PyQtX.QtWidgets import QWidget, QMessageBox, QFileDialog, QLineEdit, QApplication, QProgressBar, QTabWidget, QComboBox, QLabel, QHBoxLayout, QVBoxLayout, QCheckBox, QPlainTextEdit, QInputDialog, QPushButton, QScrollArea, QListView, QMainWindow, QGroupBox, QAction, QMenu, QToolBar, QSplitter
...
class App(QtCore.QObject):
    ...
    def message_dialog(self, title, message, kind="info"):
        icon = {"info": QMessageBox.Information,
                ...
                "error": QMessageBox.Critical}[str(kind)]
        dlg = QMessageBox(icon, title, message, parent=self.ui)
        dlg.setText(message)
        dlg.exec_()
    ...
    def on_fileopengcode(self):
        ...
        try:
            filename = QFileDialog.getOpenFileName(caption="Open G-Code",
                                                         directory=self.get_last_folder())
        except TypeError:
            filename = QFileDialog.getOpenFileName(caption="Open G-Code")
    ...
    def on_file_openproject(self):
        ...
        try:
            filename = QFileDialog.getOpenFileName(caption="Open Project",
                                                         directory=self.get_last_folder())
        except TypeError:
            filename = QFileDialog.getOpenFileName(caption="Open Project")
    ...
    def on_file_importsvg(self):
        ...
        try:
            filename = QFileDialog.getOpenFileName(caption="Import SVG",
                                                         directory=self.get_last_folder())
        except TypeError:
            filename = QFileDialog.getOpenFileName(caption="Import SVG")
    ...
    def setup_recent_items(self):
        ...
        for recent in self.recent:
            ...
            try:
                action = QAction(QtGui.QIcon(icons[recent["kind"]]), filename, self)
    ...
    def setup_component_editor(self):
        label = QLabel("Choose an item from Project")
