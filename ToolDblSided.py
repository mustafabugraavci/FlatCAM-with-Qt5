...
from PyQtX.QtWidgets import QWidget, QGridLayout, QPushButton, QFormLayout, QLineEdit, QProgressBar, QTabWidget, QComboBox, QLabel, QHBoxLayout, QVBoxLayout, QCheckBox, QPlainTextEdit, QInputDialog, QPushButton, QScrollArea, QListView, QMainWindow, QGroupBox, QAction, QMenu, QToolBar, QSplitter
...
class DblSidedTool(FlatCAMTool):
    ...
    def __init__(self, app):
        ...
        hlay.addStretch()
        self.create_alignment_hole_button = QPushButton("Create Alignment Drill")
