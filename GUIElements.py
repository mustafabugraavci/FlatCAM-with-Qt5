...
from PyQtX.QtWidgets import QWidget, QLineEdit, QCheckBox, QPlainTextEdit, QInputDialog, QPushButton, QScrollArea, QRadioButton, QHBoxLayout, QVBoxLayout, QButtonGroup
...
class FCInputDialog(QInputDialog):
...
class VerticalScrollArea(QScrollArea):
    """
    This widget extends QScrollArea to make a vertical-only
