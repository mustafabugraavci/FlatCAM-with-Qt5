...
from PyQtX.QtWidgets import QWidget, QFrame, QSizePolicy, QGridLayout, QPushButton, QFormLayout, QLineEdit, QProgressBar, QTabWidget, QComboBox, QLabel, QHBoxLayout, QVBoxLayout, QCheckBox, QPlainTextEdit, QInputDialog, QPushButton, QScrollArea, QListView, QMainWindow, QGroupBox, QAction, QMenu, QToolBar, QSplitter
...
class FlatCAMGUI(QMainWindow):
    ...
    def __init__(self, version, name=None):
        ...
        # New
        self.menufilenew = QAction(QtGui.QIcon('share/file16.png'), '&New project', self)
        ...
        # Open gerber ...
        self.menufileopengerber = QAction(QtGui.QIcon('share/folder16.png'), 'Open &Gerber ...', self)
        self.menufile.addAction(self.menufileopengerber)

        # Open Excellon ...
        self.menufileopenexcellon = QAction(QtGui.QIcon('share/folder16.png'), 'Open &Excellon ...', self)
        self.menufile.addAction(self.menufileopenexcellon)

        # Open G-Code ...
        self.menufileopengcode = QAction(QtGui.QIcon('share/folder16.png'), 'Open G-&Code ...', self)
        self.menufile.addAction(self.menufileopengcode)

        # Open Project ...
        self.menufileopenproject = QAction(QtGui.QIcon('share/folder16.png'), 'Open &Project ...', self)
        ...
        # Import SVG ...
        self.menufileimportsvg = QAction(QtGui.QIcon('share/folder16.png'), 'Import &SVG ...', self)
        self.menufile.addAction(self.menufileimportsvg)

        # Export SVG ...
        self.menufileexportsvg = QAction(QtGui.QIcon('share/folder16.png'), 'Export &SVG ...', self)
        ...
        # Save Project
        self.menufilesaveproject = QAction(QtGui.QIcon('share/floppy16.png'), '&Save Project', self)
        self.menufile.addAction(self.menufilesaveproject)

        # Save Project As ...
        self.menufilesaveprojectas = QAction(QtGui.QIcon('share/floppy16.png'), 'Save Project &As ...', self)
        self.menufile.addAction(self.menufilesaveprojectas)

        # Save Project Copy ...
        self.menufilesaveprojectcopy = QAction(QtGui.QIcon('share/floppy16.png'), 'Save Project C&opy ...', self)
        self.menufile.addAction(self.menufilesaveprojectcopy)

        # Save Defaults
        self.menufilesavedefaults = QAction(QtGui.QIcon('share/floppy16.png'), 'Save &Defaults', self)
        ...
        # Quit
        self.exit_action = QAction(QtGui.QIcon('share/power16.png'), '&Exit', self)
