...
import html
from PyQtX.QtCore import pyqtSignal, Qt
from PyQtX import QtGui
from PyQtX.QtWidgets import QWidget, QTextEdit, QFrame, QSizePolicy, QGridLayout, QPushButton, QFormLayout, QLineEdit, QProgressBar, QTabWidget, QComboBox, QLabel, QHBoxLayout, QVBoxLayout, QCheckBox, QPlainTextEdit, QInputDialog, QPushButton, QScrollArea, QListView, QMainWindow, QGroupBox, QAction, QMenu, QToolBar, QSplitter
...
class TermWidget(QWidget):
    ...
    def _append_to_browser(self, style, text):
        ...
        self._browser.moveCursor(QtGui.QTextCursor.End)
